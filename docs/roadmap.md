...
- [x] `apps/harmonie/package.json` (nom `@harmonie/app`, dépendance `@harmonie/ui: workspace:*`, React Router v6)
- [x] `apps/harmonie/vite.config.ts` (alias `@/` → `src/`)
- [x] `apps/harmonie/tsconfig.json`
- [x] `apps/harmonie/index.html` (Google Fonts `<link>`)
- [x] Tailwind CSS v4 dans `apps/harmonie` (étend le preset de `@harmonie/ui`)
- [x] `src/main.tsx` + `src/App.tsx` minimalistes
- [x] Vérification : `pnpm --filter @harmonie/app dev` démarre sur le port 5173
