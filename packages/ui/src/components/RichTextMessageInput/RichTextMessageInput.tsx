...
export const RichTextMessageInput = ({
  ...
  return (
    <div className="flex flex-col gap-1.5">
      <div className="relative rounded-sm border border-border-2 bg-surface-2 transition-[border-color,box-shadow] duration-150 focus-within:border-secondary-fg focus-within:shadow-[0_0_0_3px_color-mix(in_srgb,var(--color-secondary-fg)_20%,transparent)]">
        {showFormattingTools && (
